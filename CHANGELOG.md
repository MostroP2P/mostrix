...
## What's Changed in 0.2.8

### 🐛 Bug Fixes


* reject out-of-range trade_index before u32 cast by [@arkanoider](https://github.com/arkanoider)
* use correct NIP-06 trade key derivation path by [@arkanoider](https://github.com/arkanoider)

### 💼 Other


* fix(keys): correct NIP-06 trade key derivation path by [@arkanoider](https://github.com/arkanoider) in [#143](https://github.com/MostroP2P/mostrix/pull/143)

### 🧪 Testing


* use hardcoded cross-client trade key vectors by [@arkanoider](https://github.com/arkanoider)

## Contributors
* [@arkanoider](https://github.com/arkanoider) made their contribution in [#143](https://github.com/MostroP2P/mostrix/pull/143)

**Full Changelog**: https://github.com/MostroP2P/mostrix/compare/v0.2.7...0.2.8
