...
- **Finalize disputes**: [FINALIZE_DISPUTES.md](FINALIZE_DISPUTES.md) — Inline finalize popup (💰 pay / ↩️ refund / bond overlay when `bond_enabled`); trader `AddBondInvoice` payout popup
