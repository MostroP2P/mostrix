...
| `OrderChatAttachmentSendFailed` | Stores `PreparedOrderChatAttachment` in `AppState.pending_order_attachment_sends`; normalized to `Error` (Blossom URL + **Ctrl+Shift+O** retry hint) |
